...
import { HiArrowCircleRight, HiChartPie, HiDocumentText, HiOutlineAnnotation, HiOutlineUserGroup, HiUserCircle } from 'react-icons/hi'
    ...
    <Sidebar className='w-full md:w-56'>
      <SidebarItems>
        <SidebarItemGroup className='flex flex-col gap-1'>
          ...
          <Link to={"/dashboard?tab=dash"} className=' no-underline'>
          ...
          {currentUser.rest.isAdmin && (
          <Link to={"/dashboard?tab=users"} className=' no-underline'>
            <SidebarItem as={'div'} active={tab === 'users'} icon={HiOutlineUserGroup}>
              Users
            </SidebarItem>
          </Link>
          )}
          {currentUser.rest.isAdmin && (
          <Link to={"/dashboard?tab=comments"} className=' no-underline'>
            <SidebarItem as={'div'} active={tab === 'comments'} icon={HiOutlineAnnotation}>
              Comments
            </SidebarItem>
          </Link>
          )}
